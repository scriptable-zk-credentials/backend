...
pub async fn genproof_handler(Json(payload): Json<GenProofArgs>) -> (StatusCode, Json<GenProofResponse>) {
    // TODO: proper API lifecycle
    // TODO: First simulate the script outside of the zkVM to quickly reject in case of error, before trying to geenerate a zk-proof
    // TODO: compile scripts outside of zkVM, only send serialized AST as input
